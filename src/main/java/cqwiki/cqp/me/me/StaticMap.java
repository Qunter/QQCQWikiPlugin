...
public final class StaticMap {
     ...
     public static String README;//挑战map
     ...
     README=
                 ...
                 +" 如：查询 里昂 属性"+lineSeparator
                 +" 如：查询 光明剑士里昂 属性 25"+lineSeparator
                 +"目前提供查询的关键词如下："+WARROIRKEYMAP.keySet().toString()+lineSeparator
     ...
     public static void putwarroirkeymap(){
         ...
         WARROIRKEYMAP.put("勇", "hero_est");
         WARROIRKEYMAP.put("士", "hero_est");
         WARROIRKEYMAP.put("评", "hero_est");
         ...
         WARROIRKEYMAP.put("专", "hero_wp_r6");
         WARROIRKEYMAP.put("属", "hero_wp_r6");
         WARROIRKEYMAP.put("精", "hero_wp_r6");
         WARROIRKEYMAP.put("粹", "hero_wp_r6");
         WARROIRKEYMAP.put("武", "hero_wp_r6");
         WARROIRKEYMAP.put("器", "hero_wp_r6");
         ...
         WARROIRKEYMAP.put("能", "hero_skill");
         ...
         WARROIRKEYMAP.put("评", "hero_score");
